...
-- fixtures: PM Paula, member Milo, finance Fia; a project PZ; four people:
--   WorkerOver  -- two overlapping assignments summing to 130% (overallocated)
...
-- member Milo: sees all four rows (view_people is granted globally to `member`), but the
