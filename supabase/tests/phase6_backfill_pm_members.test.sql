...
-- exact backfill statement from 20260716000007_backfill_pm_members.sql here to prove the
-- logic itself is correct and idempotent. No `assignments` backfill is exercised here: that
